...
class Workflow_Editorial_Comments extends Workflow_Module {
    ...
    public function __construct() {
        ...
        $context_help_tab2 = array(
            '<p>' . __('Über die redaktionelle Diskussion können sich die Autoren eines Dokumentes über die weitere Bearbeitung austauschen. Redaktionelle Kommentare sind auf der Beitragsseite nicht zu sehen.', CMS_WORKFLOW_TEXTDOMAIN) . '</p>',
            '<p>' . __('In der Spalte <i>Art</i> können Sie sehen, ob es sich um einen Standard-Kommentar handelt oder um einen Kommentar im Rahmen einer redaktionellen Diskussion. Redaktionelle Kommentare können auf dieser Übersichtsseite nur in den Papierkorb verschoben, aber nicht beantwortet oder bearbeitet werden.', CMS_WORKFLOW_TEXTDOMAIN) . '</p>',
        );
    ...
    public function the_comment_form() {
        global $post;
        ?>
        <a href="#" id="workflow-comment_respond" onclick="editorialCommentReply.open();
                        return false;" class="button-primary alignright hide-if-no-js" title=" <?php _e('Kommentar hinzufügen', CMS_WORKFLOW_TEXTDOMAIN); ?>"><span><?php _e('Kommentar hinzufügen', CMS_WORKFLOW_TEXTDOMAIN); ?></span></a>
        ...
        <div id="workflow-replyrow" style="display: none;">
            ...
            <p id="workflow-replysubmit">
                <a class="workflow-replysave button-primary alignright" href="#comments-form"><span id="workflow-replybtn"><?php _e('Senden', CMS_WORKFLOW_TEXTDOMAIN) ?></span></a>
    ...
    public function the_comment($comment, $args, $depth) {
        ...
        <?php echo get_avatar($comment->comment_author_email, 50); ?>
            ...
            <div class="post-comment-wrap">
                <h5 class="comment-meta"><?php printf(__('<span class="comment-author">%1$s</span><span class="meta"> am %2$s um %3$s Uhr</span>', CMS_WORKFLOW_TEXTDOMAIN), comment_author_email_link($comment->comment_author), get_comment_date(get_option('date_format')), get_comment_time()); ?></h5>
