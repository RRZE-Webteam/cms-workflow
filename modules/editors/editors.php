...
class Workflow_Editors extends Workflow_Module {
    ...
    public function set_role_caps() {
        ...
        foreach( $all_post_types as $args ) {
            ...
            $this->role_caps[$args->cap->edit_others_posts] = sprintf(__('Andere %s bearbeiten', CMS_WORKFLOW_TEXTDOMAIN), $args->label);
            $this->role_caps[$args->cap->delete_others_posts] = sprintf(__('Andere %s löschen', CMS_WORKFLOW_TEXTDOMAIN), $args->label);
            $this->role_caps[$args->cap->edit_private_posts] = sprintf(__('Private %s bearbeiten', CMS_WORKFLOW_TEXTDOMAIN), $args->label);
            $this->role_caps[$args->cap->delete_private_posts] = sprintf(__('Private %s löschen', CMS_WORKFLOW_TEXTDOMAIN), $args->label);
            $this->role_caps[$args->cap->read_private_posts] = sprintf(__('Private %s lesen', CMS_WORKFLOW_TEXTDOMAIN), $args->label);
        }
